...
## [0.44.0] — prepared 2026-09-11 (not yet published)
...
- Package version is prepared for the next separately approved release. This branch is
  unreleased; a GitHub tag, release notes and package publication must be reconciled
  after merge. SDK v2 is outside this change's tested compatibility range.
